...
\begin{frame}
    ...
    \begin{column}{0.52\textwidth}
        \begin{figure}
            ...
            %\movie[width=0.25\linewidth]{}{fig/lec02/Moving_magnetic_domains/Moving_magnetic_domains.gif}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.575\textwidth}
			...
			\begin{figure}
                \centering
                \animategraphics[loop,autoplay, height=0.3\textheight]{4}{fig/lec02/Barkhausen_jump/Barkhausen_jump}{0}{4}
                %\movie[width=0.25\linewidth]{}{fig/lec02/Moving_magnetic_domains/Moving_magnetic_domains.gif}
