...
\begin{frame}
    ...
    \begin{figure}
		...
		\end{subfigure}
		\caption{Example for a simple magnetic actuator and its magnetic network representation (adapted from J.~B\"ocker, \textit{Mechatronics and Electrical Drives}, Paderborn University, 2019)} 
