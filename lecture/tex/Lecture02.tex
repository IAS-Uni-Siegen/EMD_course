...
\begin{frame}
    ...
    \begin{equation}
        M_{12} = M_{21} = M.
    \end{equation}
    Based on \eqref{eq:flux_linkage_transformer}, we can also split the self-inductance $L_i$ of the $i$-th coil into the sum of the leakage inductance $L_{i,\sigma}$ and the magnetizing inductance $L_{i,m}$:
    \begin{equation}
        L_i = L_{i,\sigma} + L_{i,m} = \Lambda_{ii}N_i^2 + \Lambda_{ji}N_i^2. 
    \end{equation}
