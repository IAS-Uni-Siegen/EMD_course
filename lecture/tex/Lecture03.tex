    ...
    \begin{columns}
		...
		\begin{column}{0.55\textwidth}
			\begin{figure}
				...
				\caption{DC machine cross section (adapted from J.~B\"ocker, \textit{Elektrische Antriebstechnik}, Paderborn University, 2020)}
				\label{fig:Simple_yoke_coil}
			\end{figure}
		\end{column}
		\end{columns}
...
\begin{frame}
    ...
    \begin{figure}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.85\textwidth]{fig/lec03/Commutator_and_brushes_DC_motor.jpg}
			\caption{DC machine with brush set (source: \href{https://commons.wikimedia.org/wiki/File:Commutator_and_brushes_DC_motor.jpg}{Wikimedia Commons}, C. Kral, \href{https://creativecommons.org/licenses/by/4.0/deed.en}{CC BY-SA 4.0})}
		\end{subfigure}
