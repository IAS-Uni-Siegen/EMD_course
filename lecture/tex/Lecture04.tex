...
\begin{frame}
	...
	\begin{figure}
		\begin{columns}
			...
			\end{column}
			\begin{column}{0.35\textwidth}
				\caption{\raggedright Open-circuit (no-load) test: measuring circuit and equivalent circuit diagram}
...
\begin{frame}
	...
	\begin{figure}
		\begin{columns}
			...
			\end{column}
			\begin{column}{0.35\textwidth}
				\caption{\raggedright Short-circuit test: measuring circuit and equivalent circuit diagram}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\begin{figure}
				...
				%\caption{\SI{750}{\mega\volt\ampere}, \SI{380/230}{\kilo\volt} (source: \href{https://commons.wikimedia.org/wiki/File:CG_Autotrafo_4002904.jpg}{Wikimedia Commons}, P.~Mertens, \href{https://creativecommons.org/licenses/by-sa/3.0/deed.en}{CC BY-SA 3.0})}
			\end{figure}
		\end{column}
	\end{columns}
\end{frame}
