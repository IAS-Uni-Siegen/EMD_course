...
\begin{frame}
	...
	With choosing $$\alpha = N_1/N_2$$ as the transformation factor, we receive:
	\begin{equation}
...
\begin{frame}
	...
	With choosing $$\alpha = M/L_2$$ as the transformation factor, we receive:
	\begin{equation}
...
\begin{frame}
	...
	\begin{figure}
		\includegraphics[height=0.65\textheight]{fig/lec04/Three_phase_transformer_5_legs.pdf}
		\caption{Three-phase five-leg transformer}
