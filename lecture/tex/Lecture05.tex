...
\begin{frame}
	\frametitle{Multipole stators (cont.)}
        ...
        \end{equation*}
        we can conclude that the harmonics for $p > 1$ are repeated $p$ times over the mechanical stator circumference, assuming that the mechanical design of the motor is identical for each pole pair. 
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                ...
                \caption{Representation of the coil displacement by $\Delta \vartheta$ steps for a distributed winding}
