...
\begin{frame}
    ...
    Hence, the decomposition lead to two sinusoidal fields rotating in opposite directions:
...
\begin{frame}
    ...
    \end{equation}
    Here, the negative sequences are represented by the negative harmonic orders. Finally, one can note that the amplitudes of the resulting field from the three-phase excitation are $3/2$ times higher than in the single phase case from \eqref{eq:B_single_phase_coil_fourier_series_multi_pole}.
\end{frame}