...
\begin{frame}
    ...
    \begin{figure}
            ...
            \caption{MMF of a lumped single-phase coil with $N$ turns for some current $i_\mathrm{a} \neq 0$ with the rotating integration path $\partial S$  along the \hl{circumference coordinate} $\vartheta$. The rotor is considered an unspecific solid iron dummy. Both stator and iron have infinite magnetic permeability.}
...
\begin{frame}
    ...
    With $B=\mu_0 H$ in the air gap and an \hl{alternating current} $i_\mathrm{a} = i_\mathrm{a}(t)$, we have
    \begin{equation}
    ...
    \begin{figure}
		...
		\end{subfigure}
            ...
            \begin{column}{0.3\textwidth}
                \caption{\raggedright Air gap flux density distribution of a lumped single-phase coil representing a spatiotemperal function together with its \hl{fundamental component} $B^{(1)}$} 
...
\begin{frame}
	\frametitle{Fourier analysis of the air gap flux density distribution}
        ...
        \end{equation}
        \pause
        The flux density distribution therefore is periodic and has a sinusoidal shape over $t$ as well as a rectangular shape over $\vartheta$. \pause To analyze the latter in terms of its fundamental and harmonic components, we utilize the \hl{Fourier series} expansion for some arbitrary $t\in\mathbb{R}$:
        \begin{equation}
...
\begin{frame}
	\frametitle{Fourier analysis of the air gap flux density distribution (cont.)}
        The \hl{Fourier coefficients} of \eqref{eq:fourier_series_B_single_phase_coil} are
        \begin{equation}
            \begin{split}
...
\begin{frame}
    ...
    \end{equation}
    \onslide<+->
    This series can be further decomposed into $$\sin(\frac{k \pi}{2}) = 1 \quad \mbox{for } k=1,5,9,\ldots, \qquad \sin(\frac{k \pi}{2}) = -1 \quad \mbox{for } k=3,7,11,\ldots .$$ \onslide<+-> Also, the fundamental component $\hat{B}^{(1)}$ of the air gap flux density distribution is $4/\pi$ times higher than the amplitude $\hat{B}$ of the original square wave function from \eqref{eq:B_single_phase_coil} while the harmonic amplitudes decrease with $1/k$. 
\end{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
            \begin{varblock}{Flux density harmonics}
                The existence of harmonics is to be attributed to the spatial layout of the winding. The phase current was assumed to be of pure sinusoidal form, i.e., is not causing the flux density harmonics (in our simplified investigation).
            \end{varblock}
        \end{column}
    \end{columns}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Extension to machines with more than one pole pair}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Stators with multiple pole pairs (cont.)}
...
\begin{frame}
	\frametitle{Stators with multiple pole pairs (cont.)}
        ...
        \begin{varblock}{Electrical vs. mechanical angle}
            To simplify the following analysis, we introduce the \hl{electrical angle}
            \begin{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Model superposition to three-phase stator windings}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
    ...
    \begin{columns}
		\begin{column}{0.55\textwidth}
            \onslide<1->
	        We assume an ideal \hl{three-phase stator current}:
            \begin{equation}
                \begin{split}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Three-phase stator winding schemes and winding factor}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
    ...
    \begin{equation}
        \sum_{l=0}^{q-1} \left(e^{\mathrm{j} k  p\frac{2\pi}{Q}}\right)^l =\frac{1-e^{\mathrm{j} k q p\frac{2\pi}{Q}}}{1-e^{\mathrm{j} k p\frac{2\pi}{Q}}} = \frac{e^{\mathrm{j} k q p\frac{2\pi}{Q}\frac{1}{2}}(-2\mathrm{j})\sin(k q p\frac{2\pi}{Q}\frac{1}{2})}{e^{\mathrm{j} k p\frac{2\pi}{Q}\frac{1}{2}}(-2\mathrm{j})\sin(k p\frac{2\pi}{Q}\frac{1}{2})}\uncover<+->{=e^{\mathrm{j}k\frac{2 \pi}{Q}\frac{q-1}{2}}\frac{\sin(k q p\frac{2\pi}{Q}\frac{1}{2})}{\sin(k p\frac{2\pi}{Q}\frac{1}{2})}.}
...
\begin{frame}
    ...
    \begin{columns}
		\begin{column}{0.6\textwidth}
            ...
            $$y < \rho_\mathrm{p}=\pi,$$
            the \hl{winding is called chorded}. \onslide<2->{Hence, the starting and end position of the coil are shifted towards $\pm(y/\rho_\mathrm{p})(\pi/2)$ along the circumference. Consequently, the Fourier coefficients of the chorded winding are:
            \begin{equation}
