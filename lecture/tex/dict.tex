...
\newglossaryentry{cylindrical_rotor}{
	name={cylindrical rotor},
	description={Vollpolläufer}
}
...
\newglossaryentry{front_pitch}{
	name={front pitch},
	description={Schaltschritt}
}

\newglossaryentry{back_pitch}{
	name={back pitch},
	description={Spulenweite}
}

\newglossaryentry{commutator_pitch}{
	name={commutator pitch},
	description={Kollektorschritt}
}
