...
def update_plot(i):
    ...
    Tp = np.array(
        [
            [np.cos(omega_me * t), -np.sin(omega_me * t)],
            [np.sin(omega_me * t), np.cos(omega_me * t)],
        ]
    )
    ...
    for key in ax.keys():
        if key != "motor":
            ...
            ax[key].xaxis.set_major_formatter(
                plt.FuncFormatter(lambda x, _: "{:.3f}".format(x))
            )
    ...
    circle = plt.Circle(
        (rotor_a_pos_rot[0], rotor_a_pos_rot[1]), radius_coil, color="red", fill=False
    )
    ax["motor"].add_artist(circle)
    ...
    circle = plt.Circle(
        (rotor_a_neg_rot[0], rotor_a_neg_rot[1]), radius_coil, color="red", fill=False
    )
    ax["motor"].add_artist(circle)
    ...
    if i_ra[i] > 0:
        circle = plt.Circle(
            (rotor_a_pos_rot[0], rotor_a_pos_rot[1]),
            max_marker_size_circle * i_ra[i],
            color="red",
            fill=True,
        )
        ax["motor"].plot(
            ...
            rotor_a_neg_rot[1],
            "x",
            markersize=max_marker_size_X * np.abs(i_ra[i]),
            color="red",
        )
    else:
        ax["motor"].plot(
        ...
        circle = plt.Circle(
            (rotor_a_neg_rot[0], rotor_a_neg_rot[1]),
            max_marker_size_circle * i_ra[i],
            color="red",
            fill=True,
        )
    ...
    circle = plt.Circle(
        (rotor_b_pos_rot[0], rotor_b_pos_rot[1]), radius_coil, color="blue", fill=False
    )
    ax["motor"].add_artist(circle)
    ...
    circle = plt.Circle(
        (rotor_b_neg_rot[0], rotor_b_neg_rot[1]), radius_coil, color="blue", fill=False
    )
    ax["motor"].add_artist(circle)
    ...
    if i_rb[i] > 0:
        ax["motor"].plot(
            ...
            rotor_b_pos_rot[1],
            "x",
            markersize=max_marker_size_X * np.abs(i_rb[i]),
            color="blue",
        )
        circle = plt.Circle(
            (rotor_b_neg_rot[0], rotor_b_neg_rot[1]),
            max_marker_size_circle * i_rb[i],
            color="blue",
            fill=True,
        )
    else:
        circle = plt.Circle(
            (rotor_b_pos_rot[0], rotor_b_pos_rot[1]),
            max_marker_size_circle * i_rb[i],
            color="blue",
            fill=True,
        )
    ...
    circle = plt.Circle(
        (rotor_c_pos_rot[0], rotor_c_pos_rot[1]), radius_coil, color="green", fill=False
    )
    ax["motor"].add_artist(circle)
    ...
    circle = plt.Circle(
        (rotor_c_neg_rot[0], rotor_c_neg_rot[1]), radius_coil, color="green", fill=False
    )
    ax["motor"].add_artist(circle)
    ...
    if i_rc[i] > 0:
        ax["motor"].plot(
            ...
            rotor_c_pos_rot[1],
            "x",
            markersize=max_marker_size_X * np.abs(i_rc[i]),
            color="green",
        )
        circle = plt.Circle(
            (rotor_c_neg_rot[0], rotor_c_neg_rot[1]),
            max_marker_size_circle * i_rc[i],
            color="green",
            fill=True,
        )
    else:
        circle = plt.Circle(
            (rotor_c_pos_rot[0], rotor_c_pos_rot[1]),
            max_marker_size_circle * i_rc[i],
            color="green",
            fill=True,
        )
    ...
    for j in idx:
        B_handle = ax["motor"].quiver(
            np.cos(theta_vec[j]) * radius_air_gap - B[j] * np.cos(theta_vec[j]) / 6,
    ...
    ax["motor"].quiver(
        rotor_a_pos_rot[0],
        rotor_a_pos_rot[1],
        -F_ra_pos * np.sin(eps_me_ra_pos),
        F_ra_pos * np.cos(eps_me_ra_pos),
        color="#7401d8ff",
        scale_units="xy",
        scale=3,
        width=0.005,
    ...
    ax["motor"].quiver(
        rotor_a_neg_rot[0],
        rotor_a_neg_rot[1],
        F_ra_neg * np.sin(eps_me_ra_neg),
        -F_ra_neg * np.cos(eps_me_ra_neg),
        color="#7401d8ff",
        scale_units="xy",
        scale=3,
        width=0.005,
    ...
    ax["motor"].quiver(
        rotor_b_pos_rot[0],
        rotor_b_pos_rot[1],
        F_rb_pos * np.sin(eps_me_rb_pos),
        -F_rb_pos * np.cos(eps_me_rb_pos),
        color="#7401d8ff",
        scale_units="xy",
        scale=3,
        width=0.005,
    ...
    ax["motor"].quiver(
        rotor_b_neg_rot[0],
        rotor_b_neg_rot[1],
        -F_rb_neg * np.sin(eps_me_rb_neg),
        F_rb_neg * np.cos(eps_me_rb_neg),
        color="#7401d8ff",
        scale_units="xy",
        scale=3,
        width=0.005,
    ...
    ax["motor"].quiver(
        rotor_c_pos_rot[0],
        rotor_c_pos_rot[1],
        F_rc_pos * np.sin(eps_me_rc_pos),
        -F_rc_pos * np.cos(eps_me_rc_pos),
        color="#7401d8ff",
        scale_units="xy",
        scale=3,
        width=0.005,
    )
    force_handle = ax["motor"].quiver(
        rotor_c_neg_rot[0],
        rotor_c_neg_rot[1],
        -F_rc_neg * np.sin(eps_me_rc_neg),
        F_rc_neg * np.cos(eps_me_rc_neg),
        color="#7401d8ff",
        scale_units="xy",
        scale=3,
        width=0.005,
    ...
    ax["motor"].legend(
        (B_handle, force_handle),
        ("B field (stator normal component, fundamental)", "Lorentz Force"),
        loc="lower center",
        ncol=1,
        fancybox=True,
