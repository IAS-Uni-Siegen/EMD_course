...
def update_plot(i):
    ...
    circle = plt.Circle(
        (rotor_neg_02_rot[0], rotor_neg_02_rot[1]),
        radius_coil,
        color="gray",
        fill=False,
    )
    ...
    circle = plt.Circle(
        (rotor_neg_03_rot[0], rotor_neg_03_rot[1]),
        radius_coil,
        color="gray",
        fill=False,
    )
    ...
    circle = plt.Circle(
        (rotor_neg_04_rot[0], rotor_neg_04_rot[1]),
        radius_coil,
        color="gray",
        fill=False,
    )
    ...
    rotor_polygon = plt.Polygon(
        [rotor_salient_01_rot, rotor_salient_02_rot],
        closed=True,
        fill=False,
        edgecolor="black",
    )
    ...
    rotor_polygon = plt.Polygon(
        [rotor_salient_03_rot, rotor_salient_04_rot],
        closed=True,
        fill=False,
        edgecolor="black",
    )
    ...
    rotor_upper_arc = patches.Arc(
        rotor_salient_05_rot,
        1.75 * radius_rotor_slot,
        0.42,
        angle=eps * 180 / np.pi,
        theta1=0,
        theta2=180,
    ...
    rotor_lower_arc = patches.Arc(
        rotor_salient_06_rot,
        1.75 * radius_rotor_slot,
        0.42,
        angle=eps * 180 / np.pi + 180,
        theta1=0,
        theta2=180,
        color="black",
    )
    ...
    rotor_upper_arc_start = (
        np.array([np.cos(eps), np.sin(eps)]) * 1.75 / 2 * radius_rotor_slot
        + rotor_salient_05_rot
    )
    rotor_polygon = plt.Polygon(
        [rotor_salient_03_rot, rotor_upper_arc_start],
        closed=True,
        fill=False,
        edgecolor="black",
    )
    ...
    rotor_lower_arc_start = (
        np.array([np.cos(eps + np.pi), np.sin(eps + np.pi)])
        * 1.75
        / 2
        * radius_rotor_slot
        + rotor_salient_05_rot
    ...
    rotor_polygon = plt.Polygon(
        [rotor_salient_01_rot, rotor_lower_arc_start],
        closed=True,
        fill=False,
        edgecolor="black",
    )
    ...
    rotor_polygon = plt.Polygon(
        [rotor_salient_04_rot, rotor_upper_arc_end],
        closed=True,
        fill=False,
        edgecolor="black",
    )
    ...
    rotor_polygon = plt.Polygon(
        [rotor_salient_02_rot, rotor_lower_arc_end],
        closed=True,
        fill=False,
        edgecolor="black",
    )
