...
\begin{solutionblock}
  ...
  \begin{equation}
    \ddot{u} = \frac{U_{\mathrm{2}}}{U_{\mathrm{1}}}
...
\begin{solutionblock}
  ...
  \begin{align}
    \begin{split}
      ...
      = \frac{\SI{4}{\kilo \watt}}{\SI{110}{\volt}}
      = \SI{36.4}{\ampere}, \\
      I_{\mathrm{1}} = \frac{S}{U_{\mathrm{1}}}
      = \frac{\SI{4}{\kilo \watt}}{\SI{230}{\volt}}
      = \SI{17.4}{\ampere}.
    \end{split}
  \end{align}
\end{solutionblock}
...
\begin{solutionblock}
  ...
  \begin{figure}[htb]
    \centering
    \includegraphics{ex_transformer_T_ECD_core_losses_no_load.pdf}
  ...
  \begin{equation}
    \ddot{u} = \frac{N_{\mathrm{1}}}{N_{\mathrm{2}}}
...
\begin{solutionblock}
  ...
  \begin{equation}
    N_{\mathrm{1}} = \frac{\hat{\psi}}{\phi}
    = \frac{\frac{\sqrt{2}U_{\mathrm{1}}}{\omega}}{\hat{B} S}
...
\begin{solutionblock}
  ...
  \begin{figure}[htb]
    \centering
    \includegraphics{ex_Transformer_open_circuit_test.pdf}
    \captionsetup{labelfont={color=blue},textfont={color=blue}}
...
\begin{solutionblock}
  ...
  \begin{figure}[htb]
    \centering
    \includegraphics{current_transformer.pdf}
    \captionsetup{labelfont={color=blue},textfont={color=blue}}
