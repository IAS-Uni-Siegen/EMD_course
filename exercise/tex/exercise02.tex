...
\begin{solutionblock}
	...
	By rearranging the equation from above, the no-load speed results in:
	\begin{equation}
		...
		= 26.6 \ \si{\frac{1}{s}} = 1595 \ \si{\frac{1}{min}}.
	\end{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subtask{Calculate the armature current $I_{\mathrm{a,n}}$, the torque $\Tn$, the losses $P_{\mathrm{Cu,a}}$ and $\Pfe$ + $P_{\mathrm{fr+add}}$, the armature winding resistance $R_{\mathrm{a}}$ and the no-load speed $n_{\mathrm{0}}$.}
