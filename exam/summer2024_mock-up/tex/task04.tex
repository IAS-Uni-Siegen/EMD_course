...
\begin{figure}[h!]
	...
	\begin{tikzpicture}
		...
		\draw[-{Latex[length=3mm]}, signalalpha, thick] (0,0) -- (0,3) node[left, text=black]{$\underline{U}_\mathrm{i}$};
		\draw[-{Latex[length=3mm]}, signalalpha, thick] (0,0) -- (1,2) node[right, text=black]{$\underline{U}_\mathrm{s}$};
		\draw[-{Latex[length=3mm]}, signalalpha, thick] (0,3) --  node[right, text=black]{$\Delta \underline{U}$} ++ (1,-1);
...
\begin{solutionblock}
	...
	\begin{solutionfigure}[ht]
		...
		\begin{tikzpicture}
			...
			\draw[-{Latex[length=3mm]}, signaldelta, thick] (0,0) -- (1.33,0) node[above, text=black]{$\underline{I}_\mathrm{s,sc}$};
			\draw[-{Latex[length=3mm]}, signaldelta, thick] (0,0) -- (0.11,0.62) node[left, text=black]{$\underline{I}_\mathrm{s}$};
