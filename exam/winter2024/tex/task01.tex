...
%%%%%%%%%%%
% Lukas
% Aufgabe A1.7 Binder Übungsbuch (S. 25 ff)
% Subfrage 6: statt nach Spannungsüberhöhung/-einhaltung, direkt nach erforderlicher Betriebsspannung für stat. Zustand fragen (Sprich Betriebsspannungsangabe aus dem Vortext löschen)
% Subfrage 7 (Erwärmung Kühlwasser) -> entfällt (Vortext kann entsprechend gekürzt werden, der Teil mit der Wasserkühlung ist dann irrelevant)
% Zahlenwerte gegenüber Binder verändern -> (grobe Eckpunkte): Nennungstrom hoch auf 5 kA, Nennluftspaltflussdichte hoch auf 3.141 Tesla - > ggf. weitere daraus abgeleitete Werte nach Bedarf ändern 
%%%%%%%%%%%
